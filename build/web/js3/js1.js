...
_bsa.fancybar = function (zoneKey, segment, options, ads) {
  ...
  function template(ads) {
    var a = ads[0],
      ...
      c = "";
    c +=
      '<div class="_bsa_fancybar" style="background-color:' +
      a.backgroundColor +
      ";color: " +
      a.textColor +
      '">' +
      '<div class="fancybar-center">' +
      '<a href="' +
      statlink +
      '" class="fancybar-wrap" style="color:' +
      a.textColor +
      '" target="_blank" rel="noopener sponsored">' +
      '<div class="fancybar-left">' +
      '<img class="fancybar-logo" src="' +
      logo +
      '" />' +
      '<div class="fancybar-text">' +
      '<div class="fancybar-tagline">' +
      _bsa.htmlEncode(tagline) +
      "</div>" +
      '<div class="fancybar-desc">' +
      _bsa.htmlEncode(description) +
      "</div>" +
      "</div>" +
      "</div>" +
      '<div class="fancybar-cta" style="background-color:' +
      a.ctaBackgroundColor +
      ";color:" +
      a.ctaTextColor +
      '">' +
      ...
      "</div>" +
      "</a>" +
      '<div class="fancybar-footer" style="color:' +
      a.textColor +
      '">' +
      '<span class="fancybar-close" onclick="_bsa.close(\'' +
      _bsa.fancybar.elID(options) +
      "')\">Hide Ad</span>" +
      '<a class="fancybar-via" style="color:' +
      a.textColor +
      '" href="' +
      adViaLink +
      '">Ad via BuySellAds</a>' +
...
_bsa.flexbar = function (zoneKey, segment, options, ads) {
  ...
  function css(colors) {
    ...
    style +=
      ...
      textColor +
      ";text-decoration:none;-webkit-transition:all .2s ease-in-out;-o-transition:all .2s ease-in-out;transition:all .2s ease-in-out}#_flexbar_ .flexbar-footer>*:hover{border-top-left-radius:2px;border-top-right-radius:2px;background-color:" +
      textColor +
      ";color:" +
      backgroundColor +
      ";cursor:pointer}";
  ...
  function template(ads) {
    var a = ads[0],
      ...
      c = "";
    c +=
      '<div class="_bsa_flexbar"><div class="flexbar-center"><a href="' +
      statlink +
      '" class="flexbar-wrap" target="_blank" rel="noopener sponsored"><span class="flexbar-logo"><img src="' +
      logo +
      '" /></span><span class="flexbar-text"><div class="flexbar-left"><div class="flexbar-heading"><span class="flexbar-sponsor">Sponsored by</span> ' +
      _bsa.htmlEncode(company) +
      '</div><div class="flexbar-desc">' +
      _bsa.htmlEncode(description) +
      '</div></div><span class="flexbar-cta">' +
      _bsa.htmlEncode(callToAction) +
      '</span></span></a><div class="flexbar-footer"><span class="flexbar-close" onclick="_bsa.close(\'' +
      _bsa.flexbar.elID(options) +
      '\')">Hide Ad</span> <a class="flexbar-via" href="' +
      adViaLink +
      '">Ad via BuySellAds</a></div></div>';
    c += _bsa.pixel(pixel, timestamp);
    c += "</div>";
    return c;
  }
